...
import { styles } from './SignUpForm2Style'

import ImgLogo from "../../assets/logowhite1.png"
import ImgKyc from "../../assets/kyc.png"
        ...
        <View style={styles.container}>
            ...
            <ImageBackground source={ImgBackGround} style={styles.image}>
                ...
                <View style={styles.container2}>
                    ...
                    <Text style={{color:"black",marginTop:12,fontSize:24,lineHeight:37}}>Ingresa tu Nombre</Text>
                    <Image
                        style={styles.imgKyc}
                        source={ImgKyc}
                    />
...
<Text style={{marginLeft:"7%"}}>Nombre(s)<Text style={{color:"red"}}>*</Text></Text>
      <TextInput
        style={styles.input}
      ...
      />
      <Text style={{marginLeft:"7%"}}>Apellido Paterno* <Text style={{color:"red"}}>*</Text> </Text>
      <TextInput
        style={styles.input}
      ...
      <ButtonComponent backgroundColor="#227BFF"  text="Continuar" marginTop="15%" />
    </View>
